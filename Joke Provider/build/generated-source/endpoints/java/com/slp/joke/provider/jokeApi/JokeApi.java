 ...
 * on 2017-04-02 at 21:57:01 UTC 
 * Modify at your own risk.
 */

package com.slp.joke.provider.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetJoke getJoke(java.lang.Integer numberOfJokes) throws java.io.IOException {
    GetJoke result = new GetJoke(numberOfJokes);
    initialize(result);
    return result;
  }

  public class GetJoke extends JokeApiRequest<com.slp.joke.provider.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected GetJoke(java.lang.Integer numberOfJokes) {
      super(JokeApi.this, "GET", REST_PATH, null, com.slp.joke.provider.jokeApi.model.Joke.class);
      this.numberOfJokes = com.google.api.client.util.Preconditions.checkNotNull(numberOfJokes, "Required parameter numberOfJokes must be specified.");
    }
    ...
    private java.lang.Integer numberOfJokes;

    /**

     */
    public java.lang.Integer getNumberOfJokes() {
      return numberOfJokes;
    }

    public GetJoke setNumberOfJokes(java.lang.Integer numberOfJokes) {
